...
￼
OK, well let's charitably brush over the exact name duplication 😬 Dunno what’s going on with the currency emoji (I’ve fixed that now), but yeah, they’ve got the same loose emoji loving vibe. But so what?
